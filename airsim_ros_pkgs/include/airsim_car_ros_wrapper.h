...
class AirsimCarROSWrapper
{
public:
    AirsimCarROSWrapper(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private, const std::string & host_ip);
    ~AirsimCarROSWrapper() {}; 
...
private:
    ...
    AirSimCarSettingsParser airsim_settings_parser_;
